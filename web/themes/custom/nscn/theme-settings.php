 ...
 */
function nscn_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  // If the default theme is either nscn or socialsaas then extend
